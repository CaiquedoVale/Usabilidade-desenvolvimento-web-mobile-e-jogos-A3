    ...
    <>
      ...
      <section className="score-section">
        ...
        <div className="intro-text">
          <h2>O Desafio Final: 1000 Pontos</h2>
          <p>
            A competição avalia muito mais do que quem chega primeiro. 
            É um somatório de projeto teórico, desempenho dinâmico e durabilidade.
          </p>
        </div>

        <div className="score-grid">
          <div className="score-card static">
            <h3>320 <span>pts</span></h3>
      ...
      <section className="phases-section">
        ...
        <div className="phase-block">
          ...
          <div className="phase-content">
            ...
            <p>
              Antes de ligar o motor, todo veículo deve ser aprovado na Inspeção Estática e Dinâmica. 
              Itens críticos como freios (travamento das 4 rodas), motor, gaiola e equipamentos do piloto são rigorosamente verificados.
            </p>
          </div>
        </div>
        ...
        <div className="phase-block reverse">
          ...
          <div className="phase-content">
            ...
            <p>
              Testes individuais para validar o projeto na prática: <strong>Aceleração</strong>, 
              <strong>Velocidade Máxima</strong>, <strong>Tração</strong> e o desafiador circuito de 
        ...
        <div className="phase-block">
          ...
          <div className="phase-content">
            ...
            <p>
              O evento principal. Todos os carros na pista simultaneamente por <strong>4 horas</strong>. 
              É a prova definitiva de confiabilidade. Vence quem completar mais voltas enquanto o carro aguentar.
            </p>
          </div>
        </div>
      </section>
